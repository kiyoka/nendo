...
describe Nendo, "when call replStr() with `-' function" do
  ...
  it "should" do
    ...
    @nendo.replStr( " (- 1.1 1) " ).should == "0.10000000000000009"
    @nendo.replStr( " (- 1.3 1.1) " ).should == "0.19999999999999996"
    @nendo.replStr( " (- 1 '() ) " ).should == "-1"
    @nendo.replStr( " (- 1.1 '() ) " ).should == "-1.1"
    lambda { @nendo.replStr( " (-) " ) }.should              raise_error(ArgumentError)
    lambda { @nendo.replStr( " (- '(1) ) " ) }.should        raise_error(TypeError)
...
describe Nendo, "when call replStr() with `*' function" do
  ...
  it "should" do
    ...
    @nendo.replStr( " (* 1.3 1.1) " ).should == "1.4300000000000002"
    @nendo.replStr( " (* 1 '() ) " ).should == "1"
    @nendo.replStr( " (* 1.1 '() ) " ).should == "1.1"
    lambda { @nendo.replStr( " (*) " ) }.should              raise_error(ArgumentError)
    lambda { @nendo.replStr( " (* '(1) ) " ) }.should        raise_error(TypeError)
...
describe Nendo, "when call replStr() with `/' function" do
  ...
  it "should" do
    @nendo.replStr( " (/ 1) " ).should == "1"
    @nendo.replStr( " (/ 1.1) " ).should == "0.9090909090909091"
    @nendo.replStr( " (/ 2 1) " ).should == "2"
    ...
    @nendo.replStr( " (/ 1 1.11) " ).should == "0.9009009009009008"
    @nendo.replStr( " (/ 1.3 1.1) " ).should == "1.1818181818181817"
    @nendo.replStr( " (/ 1 '() ) " ).should == "1"
    @nendo.replStr( " (/ 1.1 '() ) " ).should == "0.9090909090909091"
    lambda { @nendo.replStr( " (/) " ) }.should             raise_error(ArgumentError)
    lambda { @nendo.replStr( " (/ '() ) " ) }.should        raise_error(ArgumentError)
